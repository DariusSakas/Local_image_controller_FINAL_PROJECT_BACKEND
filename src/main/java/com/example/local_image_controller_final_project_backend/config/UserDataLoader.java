...
public class UserDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public UserDataLoader(UserModelRepository userModelRepository, RoleModelRepository roleModelRepository, PrivilegeModelRepository privilegeModelRepository, PasswordEncoder passwordEncoder) {
        this.userModelRepository = userModelRepository;
        this.roleModelRepository = roleModelRepository;
        this.privilegeModelRepository = privilegeModelRepository;
